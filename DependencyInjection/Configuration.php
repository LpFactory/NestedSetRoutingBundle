    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->children()
                ...
                ->arrayNode('service_ids')
                    ->addDefaultsIfNotSet()
                    ->children()
                        ->scalarNode('strategy')->defaultValue('lp_factory.route_strategy.single_tree')->end()
                        ->scalarNode('factory')->defaultValue('lp_factory.route_factory')->end()
                    ->end()
                ->end()
                ->arrayNode('routes')
